...
values
  ('magazine-editorial', 'Magazine', 'Ultra-realistic cinematic fashion magazine portrait', 'Trending',
  ...
  ('paparazzi', 'Paparazzi', 'Candid paparazzi-style flash street photography', 'Trending',
  ...
  ('minecraft-world', 'Minecraft', 'Real photo turned into a Minecraft voxel block world', 'Worlds',
  ...
  ('food-infographic', 'Food Infographic', 'Hyper-realistic food illustration with editorial infographic overlays', 'Creative',
  ...
  ('isometric-map', 'Isometric Map', 'Hand-drawn isometric schematic diagram of a street', 'Creative',
  ...
  ('risograph-icons', 'Risograph Icons', 'Risograph print style icon collection in a 2x2 grid', 'Creative',
  ...
  ('metallic-logo', 'Metallic Logo', 'Dark metallic heavy-lighted logos', 'Creative',
